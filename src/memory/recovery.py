...
from memory.errors import PersistenceRecoveryError
...
from models.persistence import RuntimeErrorRecord, TaskCheckpoint
    ...
    try:
        ...
        for target_task_id in active_ids:
            ...
            if target_state.phase is TargetPhase.FINALIZING:
                from memory.finalization import resolve_finalization_request
