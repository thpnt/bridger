...
def _resolve_triage_backend() -> tuple[str, str]:
    ...
    from bridger._vendor.graphify.llm import BACKENDS, _get_backend_api_key, _default_model_for_backend
...
def triage_with_opus(prs: list[PRInfo], base: str) -> None:
    try:
        from bridger._vendor.graphify.llm import BACKENDS, _get_backend_api_key
    except ImportError:
