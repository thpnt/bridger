...
def _semantic_id_remap(nodes: list, root: str | None) -> dict:
    ...
    from bridger._vendor.graphify.extractors.base import _file_stem  # local: avoid import cost at module load
...
def graph_has_legacy_ids(nodes: list, root: str | Path | None = None, sample: int = 300) -> bool:
    ...
    from bridger._vendor.graphify.extractors.base import _file_stem
...
def build_from_json(extraction: dict, *, directed: bool = False, root: str | Path | None = None) -> nx.Graph:
    ...
    from bridger._vendor.graphify.extractors.base import _file_stem as _fs
...
def build(
    ...
    *,
    ...
    """
    from bridger._vendor.graphify.dedup import deduplicate_entities
    ...
    *,
    ...
    if existing_hyperedges:
        ...
        for he in existing_hyperedges:
            ...
            carried.append(he)
        if carried:
            from bridger._vendor.graphify.export import attach_hyperedges
