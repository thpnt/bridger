...
def _reconcile_existing_graph(
    ...
    *,
    ...
    from bridger._vendor.graphify.build import _load_existing_graph
    ...
    from bridger._vendor.graphify.build import _is_ast_tier
    ...
    try:
        from bridger._vendor.graphify.build import _norm_source_file as _nsf
        from bridger._vendor.graphify.extract import _get_extractor
...
def _check_shrink(
    ...
    *,
    ...
    if rebuilt_sources is not None:
        from bridger._vendor.graphify.build import _norm_source_file
...
def _rebuild_code(
    ...
    *,
    ...
    try:
        from bridger._vendor.graphify.extract import extract, _get_extractor
        from bridger._vendor.graphify.detect import detect
        from bridger._vendor.graphify.build import build_from_json, _is_ast_tier, _norm_source_file as _nsf
        from bridger._vendor.graphify.cluster import cluster, remap_communities_to_previous, score_all
        from bridger._vendor.graphify.analyze import god_nodes, surprising_connections, suggest_questions
        ...
        if no_cluster:
            ...
            try:
                from bridger._vendor.graphify.detect import save_manifest
        ...
        from bridger._vendor.graphify.cluster import community_member_sigs
        ...
        if not no_change:
            ...
            try:
                ...
                from bridger._vendor.graphify.exporters.html import _viz_node_limit
        ...
        if callflow_files and not no_change:
            try:
                from bridger._vendor.graphify.callflow_html import write_callflow_html
