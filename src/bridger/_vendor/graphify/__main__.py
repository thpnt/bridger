...
try:
    ...
    # Bridger vendors Graphify without the standalone graphifyy distribution metadata.
    __version__ = "0.9.32"
...
# `from bridger._vendor.graphify.__main__ import <name>` keeps working unchanged.
from bridger._vendor.graphify.install import (  # noqa: E402,F401
...
from bridger._vendor.graphify.cli import (  # noqa: E402,F401
    dispatch_command,
    _StageTimer,
    _clone_repo,
    _default_graph_path,
