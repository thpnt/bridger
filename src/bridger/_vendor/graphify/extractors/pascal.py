...
import re
from bridger._vendor.graphify.extractors.base import _file_stem, _make_id
from bridger._vendor.graphify.extractors.resolution import _pascal_resolve_class, _pascal_resolve_unit
