...
def global_add(source_path: Path, repo_tag: str) -> dict:
    ...
    """
    from bridger._vendor.graphify.build import prefix_graph_for_global, prune_repo_from_graph
...
def global_remove(repo_tag: str) -> int:
    ...
    from bridger._vendor.graphify.build import prune_repo_from_graph
