...
def _is_file_node(G: nx.Graph, node_id: str) -> bool:
    ...
    if source_file:
        from bridger._vendor.graphify.build import _is_file_node_label
...
from bridger._vendor.graphify.detect import CODE_EXTENSIONS, DOC_EXTENSIONS, PAPER_EXTENSIONS, IMAGE_EXTENSIONS
