...
try:
    from bridger._vendor.graphify.watch import _rebuild_code, _apply_resource_limits
    ...
    try:
        ...
        if _md.is_dir() and any(_md.glob('*.md')):
            from bridger._vendor.graphify.reflect import reflect as _reflect
...
def _merge_attr_line() -> str:
    ...
    """
    from bridger._vendor.graphify.paths import GRAPHIFY_OUT
    out = GRAPHIFY_OUT
